...
SYSTEM_VERSION = "ULTIMATE-HYBRID-SUPREME-2026-ELITE-CLEAN-v6"
...
SIGNAL_COOLDOWN        = 1800    # 30min per symbol
HTF_REFRESH            = 300
MAX_DAILY_LOSS         = -300
...
# FIX D — ADX spike block
ADX_MAX = 55           # above this = data error
...
MAX_SIGNALS_PER_DAY = {
    "XAU/USD":4,"XAG/USD":3,"NAS100":3,"SPX500":3,"US30":3,
    "EUR/USD":4,"GBP/JPY":3,"USD/JPY":4,
    "BTC/USD":4,"ETH/USD":3,
...
DUPLICATE_WINDOWS = {
    "XAU/USD":1800,"XAG/USD":1800,"NAS100":1800,"SPX500":1800,"US30":1800,
    "EUR/USD":1800,"GBP/JPY":1800,"USD/JPY":1800,
    "BTC/USD":1800,"ETH/USD":1800,
    "NIFTY50":900,"BANKNIFTY":900,"SENSEX":900,"RELIANCE":900,"TCS":900,
}

SESSION_THRESHOLDS = {
    "Asian Precision":13,"London":12,"NY Killzone":12,"NY+London":11,
    "India Open":15,"India Midday":12,
}
...
def data_is_fresh(df):
    ...
    try:
        ...
        if age>120:
            log.info(f"STALE DATA: {age}s old")
            return False
        return True
    except: return True
...
def master_signal(symbol_key,df,session,trend,regime,
    ...
    if ENABLE_WIZARD_AI:
        ...
        best+=int(ws*0.30); wizard_score=ws
    else:
        wizard_score=0
